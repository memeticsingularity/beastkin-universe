...
| `forms/chaptered/` | 分章作品专属：`chapters/ch-001-template.md` |
...
- **`docs/spec/14-work-structure.md`** — 结构与命名**规范**（强制，校验器执行）
- **`templates/world-template/`（含本目录）** — **骨架**：有哪些文件、放在哪、叫什么
- **`.dsh/skills/`** — **填充指导**：正文怎么写（`story-craft`）、格式怎么守（`story-format-guard`）
