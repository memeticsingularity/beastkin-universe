...
> 以猎杀兽盾公司员工换取赏金为生的独立猎人，不属于任何一方阵营。
> 本目录收录赏金猎人的角色档案。
> **赏金兑换机制**：兽盾员工袜底印有编号，是领取赏金的凭证——只需提交一只袜子，无需尸体。
...
| 角色 | 种族 | 身份 | 状态 | 首次登场 | 档案 |
|------|------|------|------|---------|------|
| 炎 | 虎 | **灼流暗劲**使用者，冷酷高效，追求效率 | 存活 | 炎魉篇 ch-1 | [yan.md](yan.md) |
| 魉 | 变色龙 | 先天隐身天赋；负责善后与**记录袜底编号** | 存活 | 炎魉篇 ch-1 | [liang.md](liang.md) |
