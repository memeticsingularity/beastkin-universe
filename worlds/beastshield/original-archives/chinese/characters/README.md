# 角色档案库 / Character Archive

> 本目录是《兽盾》原作（`original-archives`）的**角色档案总库**。
> 按 **阵营** 分目录，同阵营内再按自身结构细分。
...
| 目录 | 收录对象 | 内部组织 |
|------|----------|----------|
| [`beastshield-company/`](beastshield-company/README.md) | **兽盾公司**员工（含部长级高层） | 兽种 → 制服等级 |
| [`agent-bureau/`](agent-bureau/README.md) | **特工局**成员 | 角色 |
| [`bounty-hunters/`](bounty-hunters/README.md) | **赏金猎人**（独立猎人，非任何一方雇员） | 角色 |
| [`others/`](others/README.md) | **其他**：主角、中立者、无法归入上述阵营者 | 角色 |

**分层原则**：一个角色只属于一个阵营目录。跨阵营身份（如既是特工局成员、又是十二神武传人）记在该角色档案内，不另建目录。
...
| 等级 | 制服色 | 身份 |
|------|--------|------|
| G级 | 军绿色短袖+短裤 | 杂兵 / 最底层员工 |
| E级 | 黑色紧身制服 | 武斗兵（高级近战） |
| O级 | 蓝色制服 | 监工 / 中层管理 |
| R级 | 白色紧身制服 | 枪械兵（远程） |
| W级 | 深蓝色连体摔跤服 | 摔跤兵（精英） |
| 部长级 | 原黑色制服（已不穿） | 见 [special/](beastshield-company/special/) |
...
## 四、赏金猎人 / Bounty Hunters

| 角色 | 种族 | 身份 | 状态 | 首次登场 |
|------|------|------|------|---------|
| [炎 / Yan](bounty-hunters/yan.md) | 虎 | 灼流暗劲使用者，冷酷高效 | 存活 | 炎魉篇 ch-1 |
| [魉 / Liang](bounty-hunters/liang.md) | 变色龙 | 先天隐身天赋，负责善后与记录编号 | 存活 | 炎魉篇 ch-1 |
| 黑石 / Blackstone | 纯黑肤色牛兽人 | 罪犯赏金猎人，雌雄同体 | 存活 | 短篇 ss-002 |
