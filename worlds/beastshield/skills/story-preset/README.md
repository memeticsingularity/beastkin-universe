...
| **B · ① 大狗口味** | 死亡必射/精液一定五要/处决流程/死后仪式/情感调色盘/差异化/爽点收尾/断章节奏/**五感齐备＋身体四件套＋"事后层"** | `lanse-write-skill.md` §5、`lanse-write/beastshield-writing-guidelines.md` §2、`.process/POLISH-BENCHMARK.md` |
